    ...
    <div className='session-body'>
        ...
        <div className='investing-container'>
          <div id='invest-wrap' className='investing-contents'>
            ...
            <img id='investing-image-left' src='https://robinhood-clone-assets.s3.amazonaws.com/get-started-image.png' alt='investing-image'/>
            </div>
            <div id='investing-center' className='investing-text'>
              <div className='investing-box'><h2>Investing</h2></div>
              <span id='start-building'><h2>Start building your portfolio with just </h2></span>
              <span id='start-building'><h2>$1</h2></span>
              <span id='invest-in-stocks'><h2>Invest in stocks, options, and ETFs at your pace and commission-free.</h2></span>
              <Link to="/invest">
                <button className='investing-button'>Learn more about investing</button>
              </Link>
            </div>
          </div>
          <div className='disclaimer'>
                <p>Stocks & funds offered through Robinhood Financial. Other fees may apply. </p>
          </div>
        </div>
