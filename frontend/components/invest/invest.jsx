        ...
        <>
            <div className='invest-page'>
                <div className='investing-image-container'>
                    <img id='investing-image' src='https://robinhood-clone-assets.s3.amazonaws.com/investing-image.png' alt='investing-image'/>
                </div>
                ...
                <div className = 'invest-page-body'>
                    <h1>Access stocks, ETFs, and more. Oh, and no commission fees. That’s right. Zero. Nada. Zilch. Your first stock is even on us. </h1>
                </div>
